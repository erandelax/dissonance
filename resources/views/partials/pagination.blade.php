...
@endphp
<div class="btn-toolbar p-5 w-full bg-light-lm rounded" role="toolbar" aria-label="Pagination"> <!-- mt-10 = margin-top: 1rem (10px), p-5 = padding: 0.5rem (5px), bg-light-lm = background-color: var(--gray-color-light) only in light mode, bg-very-dark-dm = background-color: var(--dark-color-dark) only in dark mode, rounded = rounded corners -->
    @if($paginator->hasPages())
        <div class="input-group ml-0"> <!-- ml-auto = margin-left: auto -->
